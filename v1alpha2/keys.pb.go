...
// source: packetbroker/api/v1alpha2/keys.proto
...
func (*KeyPointer) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d8b862eadccf303, []int{0}
}
...
func (*EncryptedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d8b862eadccf303, []int{1}
}
...
func init() {
	proto.RegisterType((*KeyPointer)(nil), "org.packetbroker.v1alpha2.KeyPointer")
	proto.RegisterType((*EncryptedData)(nil), "org.packetbroker.v1alpha2.EncryptedData")
	proto.RegisterMapType((map[string][]byte)(nil), "org.packetbroker.v1alpha2.EncryptedData.DeksEncryptedEntry")
}

func init() {
	proto.RegisterFile("packetbroker/api/v1alpha2/keys.proto", fileDescriptor_4d8b862eadccf303)
}

var fileDescriptor_4d8b862eadccf303 = []byte{
	...
	0xcc, 0x29, 0xc8, 0x48, 0x34, 0xd2, 0xcf, 0x4e, 0xad, 0x2c, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9,
	...
	0x1a, 0x59, 0x36, 0x89, 0x0d, 0x1c, 0xfe, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xbb, 0x5d,
	0x7d, 0x8f, 0xa7, 0x01, 0x00, 0x00,
}
