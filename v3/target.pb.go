...
type Target struct {
	...
	OriginNetIdAuthentication map[uint32]*Target_Authentication `protobuf:"bytes,8,rep,name=origin_net_id_authentication,json=originNetIdAuthentication,proto3" json:"origin_net_id_authentication,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *Target) GetDefaultAuthentication() isTarget_DefaultAuthentication {
	if x != nil {
		return x.DefaultAuthentication
	}
	return nil
}
...
func (x *Target) GetBasicAuth() *Target_BasicAuth {
	if x != nil {
		if x, ok := x.DefaultAuthentication.(*Target_BasicAuth_); ok {
			return x.BasicAuth
		}
	}
	return nil
...
func (x *Target) GetCustomAuth() *Target_CustomAuth {
	if x != nil {
		if x, ok := x.DefaultAuthentication.(*Target_CustomAuth_); ok {
			return x.CustomAuth
		}
	}
	return nil
...
func (x *Target) GetTlsClientAuth() *Target_TLSClientAuth {
	if x != nil {
		if x, ok := x.DefaultAuthentication.(*Target_TlsClientAuth); ok {
...
func (x *Target) GetPbTokenAuth() *Target_PacketBrokerTokenAuth {
	if x != nil {
		if x, ok := x.DefaultAuthentication.(*Target_PbTokenAuth); ok {
...
func (x *Target_Authentication) GetValue() isTarget_Authentication_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Target_Authentication) GetBasicAuth() *Target_BasicAuth {
	if x != nil {
		if x, ok := x.Value.(*Target_Authentication_BasicAuth); ok {
			return x.BasicAuth
		}
	}
	return nil
...
func (x *Target_Authentication) GetCustomAuth() *Target_CustomAuth {
	if x != nil {
		if x, ok := x.Value.(*Target_Authentication_CustomAuth); ok {
			return x.CustomAuth
		}
	}
	return nil
...
func (x *Target_Authentication) GetTlsClientAuth() *Target_TLSClientAuth {
	if x != nil {
		if x, ok := x.Value.(*Target_Authentication_TlsClientAuth); ok {
			return x.TlsClientAuth
		}
	}
	return nil
...
func (x *Target_Authentication) GetPbTokenAuth() *Target_PacketBrokerTokenAuth {
	if x != nil {
		if x, ok := x.Value.(*Target_Authentication_PbTokenAuth); ok {
			return x.PbTokenAuth
		}
	}
	return nil
...
const file_packetbroker_api_v3_target_proto_rawDesc = "" +
	"\n" +
	" packetbroker/api/v3/target.proto\x12\x13org.packetbroker.v3\x1a\x1fpacketbroker/api/v3/enums.proto\"\xb4\n" +
	"\n" +
	"\x06Target\x129\n" +
	"\bprotocol\x18\x01 \x01(\x0e2\x1d.org.packetbroker.v3.ProtocolR\bprotocol\x12\x18\n" +
	"\aaddress\x18\x02 \x01(\tR\aaddress\x12\x1a\n" +
	"\tf_ns_path\x18\t \x01(\tR\afNsPath\x12\x1a\n" +
	"\ts_ns_path\x18\n" +
	" \x01(\tR\asNsPath\x12\x1a\n" +
	"\th_ns_path\x18\v \x01(\tR\ahNsPath\x12\x19\n" +
	"\broot_cas\x18\x06 \x01(\fR\arootCas\x12F\n" +
	"\n" +
	"basic_auth\x18\x03 \x01(\v2%.org.packetbroker.v3.Target.BasicAuthH\x00R\tbasicAuth\x12I\n" +
	"\vcustom_auth\x18\x04 \x01(\v2&.org.packetbroker.v3.Target.CustomAuthH\x00R\n" +
	"customAuth\x12S\n" +
	"\x0ftls_client_auth\x18\x05 \x01(\v2).org.packetbroker.v3.Target.TLSClientAuthH\x00R\rtlsClientAuth\x12W\n" +
	"\rpb_token_auth\x18\a \x01(\v21.org.packetbroker.v3.Target.PacketBrokerTokenAuthH\x00R\vpbTokenAuth\x12{\n" +
	"\x1corigin_net_id_authentication\x18\b \x03(\v2:.org.packetbroker.v3.Target.OriginNetIdAuthenticationEntryR\x19originNetIdAuthentication\x1aC\n" +
	"\tBasicAuth\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x1a\"\n" +
	"\n" +
	"CustomAuth\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\x1a5\n" +
	"\rTLSClientAuth\x12\x12\n" +
	"\x04cert\x18\x01 \x01(\fR\x04cert\x12\x10\n" +
	"\x03key\x18\x02 \x01(\fR\x03key\x1a\x17\n" +
	"\x15PacketBrokerTokenAuth\x1a\xda\x02\n" +
	"\x0eAuthentication\x12F\n" +
	"\n" +
	"basic_auth\x18\x01 \x01(\v2%.org.packetbroker.v3.Target.BasicAuthH\x00R\tbasicAuth\x12I\n" +
	"\vcustom_auth\x18\x02 \x01(\v2&.org.packetbroker.v3.Target.CustomAuthH\x00R\n" +
	"customAuth\x12S\n" +
	"\x0ftls_client_auth\x18\x03 \x01(\v2).org.packetbroker.v3.Target.TLSClientAuthH\x00R\rtlsClientAuth\x12W\n" +
	"\rpb_token_auth\x18\x04 \x01(\v21.org.packetbroker.v3.Target.PacketBrokerTokenAuthH\x00R\vpbTokenAuthB\a\n" +
	"\x05value\x1ax\n" +
...
var (
	...
	file_packetbroker_api_v3_target_proto_rawDescData []byte
)

func file_packetbroker_api_v3_target_proto_rawDescGZIP() []byte {
	file_packetbroker_api_v3_target_proto_rawDescOnce.Do(func() {
		file_packetbroker_api_v3_target_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_packetbroker_api_v3_target_proto_rawDesc), len(file_packetbroker_api_v3_target_proto_rawDesc)))
	})
...
var file_packetbroker_api_v3_target_proto_goTypes = []any{
...
func file_packetbroker_api_v3_target_proto_init() {
	...
	file_packetbroker_api_v3_target_proto_msgTypes[0].OneofWrappers = []any{
		(*Target_BasicAuth_)(nil),
		(*Target_CustomAuth_)(nil),
		(*Target_TlsClientAuth)(nil),
		(*Target_PbTokenAuth)(nil),
	}
	file_packetbroker_api_v3_target_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_packetbroker_api_v3_target_proto_rawDesc), len(file_packetbroker_api_v3_target_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
