...
func (*NetworkTarget) Descriptor() ([]byte, []int) {
	return file_packetbroker_api_v3_networks_proto_rawDescGZIP(), []int{7}
}
...
func (x *Target_TLSClientAuth) Reset() {
	*x = Target_TLSClientAuth{}
	if protoimpl.UnsafeEnabled {
		mi := &file_packetbroker_api_v3_networks_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_packetbroker_api_v3_networks_proto_rawDesc = []byte{
	...
	0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x78, 0x0a, 0x0d, 0x4e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6e,
	...
	0x72, 0x67, 0x65, 0x74, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x65,
...
var file_packetbroker_api_v3_networks_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_packetbroker_api_v3_networks_proto_goTypes = []interface{}{
	...
	(*NetworkTarget)(nil),         // 7: org.packetbroker.v3.NetworkTarget
	(*Target_BasicAuth)(nil),      // 8: org.packetbroker.v3.Target.BasicAuth
	(*Target_CustomAuth)(nil),     // 9: org.packetbroker.v3.Target.CustomAuth
	(*Target_TLSClientAuth)(nil),  // 10: org.packetbroker.v3.Target.TLSClientAuth
	(*ContactInfo)(nil),           // 11: org.packetbroker.v3.ContactInfo
	(Right)(0),                    // 12: org.packetbroker.v3.Right
	(*timestamppb.Timestamp)(nil), // 13: google.protobuf.Timestamp
	(APIKeyState)(0),              // 14: org.packetbroker.v3.APIKeyState
	(TargetProtocol)(0),           // 15: org.packetbroker.v3.TargetProtocol
}
var file_packetbroker_api_v3_networks_proto_depIdxs = []int32{
	...
	11, // 1: org.packetbroker.v3.Network.administrative_contact:type_name -> org.packetbroker.v3.ContactInfo
	11, // 2: org.packetbroker.v3.Network.technical_contact:type_name -> org.packetbroker.v3.ContactInfo
	...
	11, // 5: org.packetbroker.v3.Tenant.administrative_contact:type_name -> org.packetbroker.v3.ContactInfo
	11, // 6: org.packetbroker.v3.Tenant.technical_contact:type_name -> org.packetbroker.v3.ContactInfo
	...
	12, // 11: org.packetbroker.v3.NetworkAPIKey.rights:type_name -> org.packetbroker.v3.Right
	13, // 12: org.packetbroker.v3.NetworkAPIKey.authenticated_at:type_name -> google.protobuf.Timestamp
	14, // 13: org.packetbroker.v3.NetworkAPIKey.state:type_name -> org.packetbroker.v3.APIKeyState
	15, // 14: org.packetbroker.v3.Target.protocol:type_name -> org.packetbroker.v3.TargetProtocol
	8,  // 15: org.packetbroker.v3.Target.basic_auth:type_name -> org.packetbroker.v3.Target.BasicAuth
	9,  // 16: org.packetbroker.v3.Target.custom_auth:type_name -> org.packetbroker.v3.Target.CustomAuth
	10, // 17: org.packetbroker.v3.Target.tls_client_auth:type_name -> org.packetbroker.v3.Target.TLSClientAuth
	6,  // 18: org.packetbroker.v3.NetworkTarget.target:type_name -> org.packetbroker.v3.Target
...
func file_packetbroker_api_v3_networks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_packetbroker_api_v3_networks_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
