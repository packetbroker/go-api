...
// source: packetbroker/api/v1beta3/keys.proto
...
func (*KeyPointer) Descriptor() ([]byte, []int) {
	return fileDescriptor_fba0ae72abfb66ec, []int{0}
}
...
func (*EncryptedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_fba0ae72abfb66ec, []int{1}
}
...
func init() {
	proto.RegisterType((*KeyPointer)(nil), "org.packetbroker.v1beta3.KeyPointer")
	proto.RegisterType((*EncryptedData)(nil), "org.packetbroker.v1beta3.EncryptedData")
	proto.RegisterMapType((map[string][]byte)(nil), "org.packetbroker.v1beta3.EncryptedData.DeksEncryptedEntry")
}

func init() {
	proto.RegisterFile("packetbroker/api/v1beta3/keys.proto", fileDescriptor_fba0ae72abfb66ec)
}

var fileDescriptor_fba0ae72abfb66ec = []byte{
	...
	0x4a, 0x2d, 0x49, 0x34, 0xd6, 0xcf, 0x4e, 0xad, 0x2c, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17,
	...
	0x59, 0x32, 0x89, 0x0d, 0x1c, 0xf8, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x60, 0x0c, 0x0c,
	0x06, 0xa3, 0x01, 0x00, 0x00,
}
