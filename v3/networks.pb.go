...
type NetworkAPIKey struct {
	...
	// Network rights.
	Rights []APIKeyRight `protobuf:"varint,7,rep,packed,name=rights,proto3,enum=org.packetbroker.v3.APIKeyRight" json:"rights,omitempty"`
...
func (x *NetworkAPIKey) GetRights() []APIKeyRight {
	if x != nil {
		return x.Rights
	}
	return nil
...
var file_packetbroker_api_v3_networks_proto_rawDesc = []byte{
	...
	0x08, 0x03, 0x10, 0x04, 0x22, 0x3d, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x41, 0x64, 0x64, 0x72, 0x50,
	...
	0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x8c, 0x02, 0x0a, 0x0d, 0x4e, 0x65, 0x74, 0x77,
	...
	0x72, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x06, 0x72, 0x69, 0x67, 0x68, 0x74, 0x73, 0x18, 0x07, 0x20,
	0x03, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74,
	0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e, 0x70, 0x61, 0x63,
...
var file_packetbroker_api_v3_networks_proto_goTypes = []interface{}{
	...
	(*NetworkAPIKey)(nil),         // 4: org.packetbroker.v3.NetworkAPIKey
	(*ContactInfo)(nil),           // 5: org.packetbroker.v3.ContactInfo
	(APIKeyRight)(0),              // 6: org.packetbroker.v3.APIKeyRight
...
var file_packetbroker_api_v3_networks_proto_depIdxs = []int32{
	...
	6, // 7: org.packetbroker.v3.NetworkAPIKey.rights:type_name -> org.packetbroker.v3.APIKeyRight
	7, // 8: org.packetbroker.v3.NetworkAPIKey.authenticated_at:type_name -> google.protobuf.Timestamp
