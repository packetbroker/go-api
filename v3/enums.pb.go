...
type APIKeyRight int32

const (
	// Right to list networks and get network information.
	APIKeyRight_READ_NETWORK APIKeyRight = 0
	// Right to read contact information of networks.
	APIKeyRight_READ_NETWORK_CONTACT APIKeyRight = 1
	// Right to list network tenants and read tenants information.
	APIKeyRight_READ_TENANT APIKeyRight = 2
	// Right to read contact information of tenants.
	APIKeyRight_READ_TENANT_CONTACT APIKeyRight = 3
)

// Enum value maps for APIKeyRight.
var (
	APIKeyRight_name = map[int32]string{
		0: "READ_NETWORK",
		1: "READ_NETWORK_CONTACT",
		2: "READ_TENANT",
		3: "READ_TENANT_CONTACT",
	}
	APIKeyRight_value = map[string]int32{
		"READ_NETWORK":         0,
...
func (x APIKeyRight) Enum() *APIKeyRight {
	p := new(APIKeyRight)
	*p = x
	return p
}

func (x APIKeyRight) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (APIKeyRight) Descriptor() protoreflect.EnumDescriptor {
	return file_packetbroker_api_v3_enums_proto_enumTypes[6].Descriptor()
}

func (APIKeyRight) Type() protoreflect.EnumType {
	return &file_packetbroker_api_v3_enums_proto_enumTypes[6]
}

func (x APIKeyRight) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use APIKeyRight.Descriptor instead.
func (APIKeyRight) EnumDescriptor() ([]byte, []int) {
...
var file_packetbroker_api_v3_enums_proto_rawDesc = []byte{
	...
	0x10, 0x01, 0x2a, 0x63, 0x0a, 0x0b, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x52, 0x69, 0x67, 0x68,
	...
	0x4e, 0x54, 0x41, 0x43, 0x54, 0x10, 0x03, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e, 0x70, 0x61,
