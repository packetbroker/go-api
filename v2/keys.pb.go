...
// source: packetbroker/api/v2/keys.proto
...
func (*KeyPointer) Descriptor() ([]byte, []int) {
	return fileDescriptor_eeca666321155a91, []int{0}
}
...
func (*EncryptedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_eeca666321155a91, []int{1}
}
...
func init() {
	proto.RegisterType((*KeyPointer)(nil), "org.packetbroker.v2.KeyPointer")
	proto.RegisterType((*EncryptedData)(nil), "org.packetbroker.v2.EncryptedData")
	proto.RegisterMapType((map[string][]byte)(nil), "org.packetbroker.v2.EncryptedData.DeksEncryptedEntry")
}

func init() { proto.RegisterFile("packetbroker/api/v2/keys.proto", fileDescriptor_eeca666321155a91) }

var fileDescriptor_eeca666321155a91 = []byte{
	...
	0x43, 0x56, 0xa3, 0x57, 0x66, 0xa4, 0xe4, 0xca, 0xc5, 0xe5, 0x9d, 0x5a, 0x19, 0x90, 0x9f, 0x99,
	...
	0xb6, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x62, 0x4c, 0x8f, 0x6d, 0x8f, 0x01, 0x00, 0x00,
}
