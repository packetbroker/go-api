...
// source: packetbroker/api/v1beta1/keys.proto
...
func (*KeyPointer) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4eb67f048fe5931, []int{0}
}
...
func (*EncryptedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4eb67f048fe5931, []int{1}
}
...
func init() {
	proto.RegisterType((*KeyPointer)(nil), "org.packetbroker.v1beta1.KeyPointer")
	proto.RegisterType((*EncryptedData)(nil), "org.packetbroker.v1beta1.EncryptedData")
	proto.RegisterMapType((map[string][]byte)(nil), "org.packetbroker.v1beta1.EncryptedData.DeksEncryptedEntry")
}

func init() {
	proto.RegisterFile("packetbroker/api/v1beta1/keys.proto", fileDescriptor_b4eb67f048fe5931)
}

var fileDescriptor_b4eb67f048fe5931 = []byte{
	...
	0x59, 0x32, 0x89, 0x0d, 0x1c, 0xf8, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xef, 0x27, 0x64,
	0xc3, 0xa3, 0x01, 0x00, 0x00,
}
