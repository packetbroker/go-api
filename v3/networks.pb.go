...
type Network struct {
	...
	AdministrativeContact *ContactInfo `protobuf:"bytes,3,opt,name=administrative_contact,json=administrativeContact,proto3" json:"administrative_contact,omitempty"`
	// Technical contact.
	TechnicalContact *ContactInfo `protobuf:"bytes,4,opt,name=technical_contact,json=technicalContact,proto3" json:"technical_contact,omitempty"`
}
...
type APIKey struct {
	...
	AuthenticatedAt *timestamp.Timestamp `protobuf:"bytes,5,opt,name=authenticated_at,json=authenticatedAt,proto3" json:"authenticated_at,omitempty"`
	// Secret key value.
...
func (x *APIKey) GetAuthenticatedAt() *timestamp.Timestamp {
	if x != nil {
...
var file_packetbroker_api_v3_networks_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc, 0x01,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x57, 0x0a, 0x16, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x69, 0x73, 0x74,
	0x72, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x18, 0x03,
	...
	0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x70,
	...
	0x6e, 0x69, 0x63, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x22, 0xc9, 0x02, 0x0a,
	...
	0x63, 0x74, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0x3d, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x41,
	0x64, 0x64, 0x72, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	...
	0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x22, 0x81, 0x01, 0x0a, 0x0c, 0x44, 0x65, 0x76, 0x41,
	0x64, 0x64, 0x72, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x3a, 0x0a, 0x06, 0x70, 0x72, 0x65, 0x66,
	...
	0x65, 0x66, 0x69, 0x78, 0x12, 0x35, 0x0a, 0x17, 0x68, 0x6f, 0x6d, 0x65, 0x5f, 0x6e, 0x65, 0x74,
	...
	0x72, 0x6b, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0xcb, 0x01, 0x0a, 0x06,
	0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x12, 0x15, 0x0a, 0x06, 0x6b, 0x65, 0x79, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x12, 0x15, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e,
...
var file_packetbroker_api_v3_networks_proto_depIdxs = []int32{
	5, // 0: org.packetbroker.v3.Network.administrative_contact:type_name -> org.packetbroker.v3.ContactInfo
	5, // 1: org.packetbroker.v3.Network.technical_contact:type_name -> org.packetbroker.v3.ContactInfo
	3, // 2: org.packetbroker.v3.Tenant.dev_addr_blocks:type_name -> org.packetbroker.v3.DevAddrBlock
	5, // 3: org.packetbroker.v3.Tenant.administrative_contact:type_name -> org.packetbroker.v3.ContactInfo
	5, // 4: org.packetbroker.v3.Tenant.technical_contact:type_name -> org.packetbroker.v3.ContactInfo
	2, // 5: org.packetbroker.v3.DevAddrBlock.prefix:type_name -> org.packetbroker.v3.DevAddrPrefix
	6, // 6: org.packetbroker.v3.APIKey.authenticated_at:type_name -> google.protobuf.Timestamp
