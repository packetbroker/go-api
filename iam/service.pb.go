...
type ListAPIKeysResponse struct {
	...
	Keys []*v3.APIKey `protobuf:"bytes,1,rep,name=keys,proto3" json:"keys,omitempty"`
}
...
func (x *ListAPIKeysResponse) GetKeys() []*v3.APIKey {
	if x != nil {
		return x.Keys
	}
	return nil
...
type CreateAPIKeyResponse struct {
	...
	Key *v3.APIKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
}
...
func (x *CreateAPIKeyResponse) GetKey() *v3.APIKey {
	if x != nil {
		return x.Key
	}
	return nil
...
var file_packetbroker_api_iam_v1_service_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x46, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2f, 0x0a, 0x04, 0x6b, 0x65, 0x79,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x70, 0x61,
	0x63, 0x6b, 0x65, 0x74, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x41, 0x50,
	0x49, 0x4b, 0x65, 0x79, 0x52, 0x04, 0x6b, 0x65, 0x79, 0x73, 0x22, 0x68, 0x0a, 0x13, 0x43, 0x72,
	...
	0x65, 0x72, 0x49, 0x64, 0x22, 0x26, 0x0a, 0x0d, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6b, 0x65, 0x79, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x14,
	...
	0x6f, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x52, 0x03,
...
var file_packetbroker_api_iam_v1_service_proto_goTypes = []interface{}{
	...
	(*v3.APIKey)(nil),              // 26: org.packetbroker.v3.APIKey
...
var file_packetbroker_api_iam_v1_service_proto_depIdxs = []int32{
	...
	26, // 18: org.packetbroker.iam.v1.ListAPIKeysResponse.keys:type_name -> org.packetbroker.v3.APIKey
	26, // 19: org.packetbroker.iam.v1.CreateAPIKeyResponse.key:type_name -> org.packetbroker.v3.APIKey
