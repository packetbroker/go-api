...
type Target struct {
	...
	//	*Target_BasicAuth_
	//	*Target_CustomAuth_
	//	*Target_CustomTlsClientAuth
	//	*Target_PbTokenAuth
	//	*Target_PbTlsClientAuth
...
func (x *Target) GetCustomTlsClientAuth() *Target_CustomTLSClientAuth {
	if x, ok := x.GetDefaultAuthentication().(*Target_CustomTlsClientAuth); ok {
		return x.CustomTlsClientAuth
	}
	return nil
}
...
func (x *Target) GetPbTlsClientAuth() *Target_PacketBrokerTLSClientAuth {
	if x, ok := x.GetDefaultAuthentication().(*Target_PbTlsClientAuth); ok {
		return x.PbTlsClientAuth
	}
	return nil
}
...
type Target_CustomTlsClientAuth struct {
	CustomTlsClientAuth *Target_CustomTLSClientAuth `protobuf:"bytes,5,opt,name=custom_tls_client_auth,json=customTlsClientAuth,proto3,oneof"`
}
...
type Target_PbTlsClientAuth struct {
	PbTlsClientAuth *Target_PacketBrokerTLSClientAuth `protobuf:"bytes,12,opt,name=pb_tls_client_auth,json=pbTlsClientAuth,proto3,oneof"`
}
...
func (*Target_CustomTlsClientAuth) isTarget_DefaultAuthentication() {}

func (*Target_PbTokenAuth) isTarget_DefaultAuthentication() {}

func (*Target_PbTlsClientAuth) isTarget_DefaultAuthentication() {}
...
func (x *Target_CustomTLSClientAuth) Reset() {
	*x = Target_CustomTLSClientAuth{}
	if protoimpl.UnsafeEnabled {
...
func (x *Target_CustomTLSClientAuth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Target_CustomTLSClientAuth) ProtoMessage() {}

func (x *Target_CustomTLSClientAuth) ProtoReflect() protoreflect.Message {
	mi := &file_packetbroker_api_v3_target_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Target_CustomTLSClientAuth.ProtoReflect.Descriptor instead.
func (*Target_CustomTLSClientAuth) Descriptor() ([]byte, []int) {
	return file_packetbroker_api_v3_target_proto_rawDescGZIP(), []int{0, 2}
}

func (x *Target_CustomTLSClientAuth) GetCert() []byte {
	if x != nil {
		return x.Cert
	}
	return nil
...
func (x *Target_CustomTLSClientAuth) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
type Target_PacketBrokerTLSClientAuth struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Target_PacketBrokerTLSClientAuth) Reset() {
	*x = Target_PacketBrokerTLSClientAuth{}
	if protoimpl.UnsafeEnabled {
...
func (x *Target_PacketBrokerTLSClientAuth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Target_PacketBrokerTLSClientAuth) ProtoMessage() {}

func (x *Target_PacketBrokerTLSClientAuth) ProtoReflect() protoreflect.Message {
	mi := &file_packetbroker_api_v3_target_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Target_PacketBrokerTLSClientAuth.ProtoReflect.Descriptor instead.
func (*Target_PacketBrokerTLSClientAuth) Descriptor() ([]byte, []int) {
...
type Target_Authentication struct {
	...
	//	*Target_Authentication_CustomTlsClientAuth
	//	*Target_Authentication_PbTokenAuth
	//	*Target_Authentication_PbTlsClientAuth
...
func (x *Target_Authentication) Reset() {
	*x = Target_Authentication{}
	if protoimpl.UnsafeEnabled {
		mi := &file_packetbroker_api_v3_target_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Target_Authentication) Descriptor() ([]byte, []int) {
	return file_packetbroker_api_v3_target_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *Target_Authentication) GetCustomTlsClientAuth() *Target_CustomTLSClientAuth {
	if x, ok := x.GetValue().(*Target_Authentication_CustomTlsClientAuth); ok {
		return x.CustomTlsClientAuth
	}
	return nil
}
...
func (x *Target_Authentication) GetPbTlsClientAuth() *Target_PacketBrokerTLSClientAuth {
	if x, ok := x.GetValue().(*Target_Authentication_PbTlsClientAuth); ok {
		return x.PbTlsClientAuth
	}
	return nil
}
...
type Target_Authentication_CustomTlsClientAuth struct {
	CustomTlsClientAuth *Target_CustomTLSClientAuth `protobuf:"bytes,3,opt,name=custom_tls_client_auth,json=customTlsClientAuth,proto3,oneof"`
}
...
type Target_Authentication_PbTlsClientAuth struct {
	PbTlsClientAuth *Target_PacketBrokerTLSClientAuth `protobuf:"bytes,5,opt,name=pb_tls_client_auth,json=pbTlsClientAuth,proto3,oneof"`
}
...
func (*Target_Authentication_CustomTlsClientAuth) isTarget_Authentication_Value() {}

func (*Target_Authentication_PbTokenAuth) isTarget_Authentication_Value() {}

func (*Target_Authentication_PbTlsClientAuth) isTarget_Authentication_Value() {}
...
var file_packetbroker_api_v3_target_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9, 0x0c, 0x0a, 0x06, 0x54, 0x61, 0x72,
	...
	,
	...
	0x6f, 0x72, 0x64, 0x1a, 0x22, 0x0a, 0x0a, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x41, 0x75, 0x74,
	0x68, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x3b, 0x0a, 0x13, 0x43, 0x75, 0x73, 0x74, 0x6f,
	0x6d, 0x54, 0x4c, 0x53, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x41, 0x75, 0x74, 0x68, 0x12, 0x12,
	...
	0x03, 0x6b, 0x65, 0x79, 0x1a, 0x17, 0x0a, 0x15, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x42, 0x72,
	0x6f, 0x6b, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x75, 0x74, 0x68, 0x1a, 0x1b, 0x0a,
	0x19, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x42, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x54, 0x4c, 0x53,
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x41, 0x75, 0x74, 0x68, 0x1a, 0xd3, 0x03, 0x0a, 0x0e, 0x41,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x18, 0x0a, 0x16, 0x64, 0x65,
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x65,
...
var file_packetbroker_api_v3_target_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_packetbroker_api_v3_target_proto_goTypes = []interface{}{
	...
	(*Target_CustomTLSClientAuth)(nil),       // 3: org.packetbroker.v3.Target.CustomTLSClientAuth
	(*Target_PacketBrokerTokenAuth)(nil),     // 4: org.packetbroker.v3.Target.PacketBrokerTokenAuth
	(*Target_PacketBrokerTLSClientAuth)(nil), // 5: org.packetbroker.v3.Target.PacketBrokerTLSClientAuth
	(*Target_Authentication)(nil),            // 6: org.packetbroker.v3.Target.Authentication
	nil,                                      // 7: org.packetbroker.v3.Target.OriginNetIdAuthenticationEntry
	(Protocol)(0),                            // 8: org.packetbroker.v3.Protocol
}
var file_packetbroker_api_v3_target_proto_depIdxs = []int32{
	8,  // 0: org.packetbroker.v3.Target.protocol:type_name -> org.packetbroker.v3.Protocol
	...
	3,  // 3: org.packetbroker.v3.Target.custom_tls_client_auth:type_name -> org.packetbroker.v3.Target.CustomTLSClientAuth
	4,  // 4: org.packetbroker.v3.Target.pb_token_auth:type_name -> org.packetbroker.v3.Target.PacketBrokerTokenAuth
	5,  // 5: org.packetbroker.v3.Target.pb_tls_client_auth:type_name -> org.packetbroker.v3.Target.PacketBrokerTLSClientAuth
	7,  // 6: org.packetbroker.v3.Target.origin_net_id_authentication:type_name -> org.packetbroker.v3.Target.OriginNetIdAuthenticationEntry
	1,  // 7: org.packetbroker.v3.Target.Authentication.basic_auth:type_name -> org.packetbroker.v3.Target.BasicAuth
	2,  // 8: org.packetbroker.v3.Target.Authentication.custom_auth:type_name -> org.packetbroker.v3.Target.CustomAuth
	3,  // 9: org.packetbroker.v3.Target.Authentication.custom_tls_client_auth:type_name -> org.packetbroker.v3.Target.CustomTLSClientAuth
	4,  // 10: org.packetbroker.v3.Target.Authentication.pb_token_auth:type_name -> org.packetbroker.v3.Target.PacketBrokerTokenAuth
	5,  // 11: org.packetbroker.v3.Target.Authentication.pb_tls_client_auth:type_name -> org.packetbroker.v3.Target.PacketBrokerTLSClientAuth
	6,  // 12: org.packetbroker.v3.Target.OriginNetIdAuthenticationEntry.value:type_name -> org.packetbroker.v3.Target.Authentication
...
func file_packetbroker_api_v3_target_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_packetbroker_api_v3_target_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Target_CustomTLSClientAuth); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_packetbroker_api_v3_target_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Target_PacketBrokerTLSClientAuth); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_packetbroker_api_v3_target_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_packetbroker_api_v3_target_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Target_CustomTlsClientAuth)(nil),
		(*Target_PbTokenAuth)(nil),
		(*Target_PbTlsClientAuth)(nil),
	}
	file_packetbroker_api_v3_target_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*Target_Authentication_BasicAuth)(nil),
		(*Target_Authentication_CustomAuth)(nil),
		(*Target_Authentication_CustomTlsClientAuth)(nil),
		(*Target_Authentication_PbTokenAuth)(nil),
		(*Target_Authentication_PbTlsClientAuth)(nil),
	}
	type x struct{}
