...
type Gateway struct {
	...
	RxCount *wrapperspb.UInt64Value `protobuf:"bytes,11,opt,name=rx_count,json=rxCount,proto3" json:"rx_count,omitempty"`
	// Number of transmitted messages.
	// Subscribing Home Networks receive this value if the Gateway Visibility has counters set.
	TxCount *wrapperspb.UInt64Value `protobuf:"bytes,12,opt,name=tx_count,json=txCount,proto3" json:"tx_count,omitempty"`
...
func (x *Gateway) GetRxCount() *wrapperspb.UInt64Value {
	if x != nil {
		return x.RxCount
	}
	return nil
...
func (x *Gateway) GetTxCount() *wrapperspb.UInt64Value {
	if x != nil {
		return x.TxCount
	}
	return nil
...
func (x *Gateway_Terrestrial) GetAntennaCount() *wrapperspb.UInt32Value {
	if x != nil {
		return x.AntennaCount
	}
	return nil
...
func (x *Gateway_Terrestrial) GetFineTimestamps() *wrapperspb.BoolValue {
	if x != nil {
		return x.FineTimestamps
	}
	return nil
