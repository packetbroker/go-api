...
// source: packetbroker/api/v1beta2/keys.proto
...
func (*KeyPointer) Descriptor() ([]byte, []int) {
	return fileDescriptor_7253a8ecf6c7ad2e, []int{0}
}
...
func (*EncryptedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_7253a8ecf6c7ad2e, []int{1}
}
...
func init() {
	proto.RegisterType((*KeyPointer)(nil), "org.packetbroker.v1beta2.KeyPointer")
	proto.RegisterType((*EncryptedData)(nil), "org.packetbroker.v1beta2.EncryptedData")
	proto.RegisterMapType((map[string][]byte)(nil), "org.packetbroker.v1beta2.EncryptedData.DeksEncryptedEntry")
}

func init() {
	proto.RegisterFile("packetbroker/api/v1beta2/keys.proto", fileDescriptor_7253a8ecf6c7ad2e)
}

var fileDescriptor_7253a8ecf6c7ad2e = []byte{
	...
	0x4a, 0x2d, 0x49, 0x34, 0xd2, 0xcf, 0x4e, 0xad, 0x2c, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17,
	...
	0x59, 0x32, 0x89, 0x0d, 0x1c, 0xf8, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x87, 0x9a, 0x00,
	0x89, 0xa3, 0x01, 0x00, 0x00,
}
